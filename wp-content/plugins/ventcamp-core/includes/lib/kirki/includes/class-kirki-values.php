		...
		if ( 'theme_mod' == Kirki::$config[ $config_id ]['option_type'] ) {
			...
			if ( '' != Kirki::$config[ $config_id ]['option_name'] ) {
				...
				if ( 'background' == Kirki::$fields[ $field_id ]['type'] ) {
					 ...
					 */
					$field_default_value = '';
					if(isset(Kirki::$fields[ $field_id ]['default'])){
						$field_default_value = Kirki::$fields[ $field_id ]['default'];
					}
					$value = ( isset( $options[ $setting_modified ] ) ) ? $options[ $setting_modified ] : $field_default_value;
