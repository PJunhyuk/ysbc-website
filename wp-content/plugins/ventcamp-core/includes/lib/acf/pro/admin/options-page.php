		...
		if( !empty($pages) ) {
			...
			foreach( $pages as $page ) {
				...
				if( empty($page['parent_slug']) ) {
					...
					// add page
					$slug = add_theme_page( $page['page_title'], $page['menu_title'], $page['capability'], $page['menu_slug'], array($this, 'html'), $page['icon_url'], $page['position'] );
					
				} else {
					
					// add page
					$slug = add_theme_page( $page['parent_slug'], $page['page_title'], $page['menu_title'], $page['capability'], $page['menu_slug'], array($this, 'html') );
