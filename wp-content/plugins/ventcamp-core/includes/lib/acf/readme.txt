...
* Core: Added new setting 'export_translate' to customise which field settings should be wrapped in 
...
* Core: Added new setting 'export_textdomain' to add  to generated export code
...
* Core: Removed  wrappers from PHP export, as these did not work as expected
...
* Export: wrapped title and instructions in  function - http://support.advancedcustomfields.com/forums/topic/wrap-labels-and-descriptions-with-__-in-the-php-export-file/
...
* Added  and  functions to more text throughout plugin
...
* All Text has been wrapped in the  /  functions to support translations!
