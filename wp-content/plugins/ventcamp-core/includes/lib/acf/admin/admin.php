...
class acf_admin {
	...
	*/
	...
	function admin_menu() {
		...
		// add parent
		add_theme_page(__("Custom Fields",'acf'), __("Custom Fields",'acf'), $cap, $slug, false, 'dashicons-welcome-widgets-menus', '80.025');
		
		
		// add children
		add_theme_page($slug, __('Field Groups','acf'), __('Field Groups','acf'), $cap, $slug );
		add_theme_page($slug, __('Add New','acf'), __('Add New','acf'), $cap, 'post-new.php?post_type=acf-field-group' );
