...
class acf_admin_update {
	...
	*/
	...
	function network_admin_menu() {
		...
		// add page
		add_theme_page('update-core.php', __('Upgrade ACF','acf'), __('Upgrade ACF','acf'), acf_get_setting('capability'),'acf-upgrade', array($this,'network_html'));
	...
	*/
	...
	function admin_menu() {
		...
		// add page
		add_theme_page('edit.php?post_type=acf-field-group', __('Upgrade','acf'), __('Upgrade','acf'), acf_get_setting('capability'),'acf-upgrade', array($this,'html') );
