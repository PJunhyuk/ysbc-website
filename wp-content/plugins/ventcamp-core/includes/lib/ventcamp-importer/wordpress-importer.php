...
URI: http://wordpress.org/extend/plugins/wordpress-importer/
...
<?php if ( ! empty( $this->authors ) ) : ?>
	<h3><?php esc_html__( 'Assign Authors', 'wordpress-importer' ); ?></h3>
	<p><?php esc_html__( 'To make it easier for you to edit and save the imported content, you may want to reassign the author of the imported item to an existing user of this site. For example, you may want to import all the entries as <code>admin</code>s entries.', 'wordpress-importer' ); ?></p>
...
<?php if ( $this->allow_fetch_attachments() ) : ?>
	<h3><?php esc_html__( 'Import Attachments', 'wordpress-importer' ); ?></h3>
	<p>
...
<?php
	...
	function author_select( $n, $author ) {
		esc_html__( 'Import author:', 'wordpress-importer' );
		...
		if ( $create_users ) {
			if ( $this->version != '1.0' ) {
				esc_html__( 'or create new user with login name:', 'wordpress-importer' );
				$value = '';
			} else {
				esc_html__( 'as a new user:', 'wordpress-importer' );
		...
		if ( ! $create_users && $this->version == '1.0' )
			esc_html__( 'assign posts to an existing user:', 'wordpress-importer' );
		else
			esc_html__( 'or assign posts to an existing user:', 'wordpress-importer' );
	...
	function process_menu_item( $item ) {
		...
		if ( ! $menu_slug ) {
			esc_html__( 'Menu item skipped due to missing menu slug', 'wordpress-importer' );
			echo '<br />';
			return;
		}
