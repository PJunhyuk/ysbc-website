                                                                ...
                                                                <table width="260" border="0" cellspacing="0" cellpadding="0" align="center" style="background-color:#ffffff;border-collapse:collapse" class="contenttable contenttable_text_inner">
                                                                        <?php if($ticket['WooCommerceEventsTicketDisplayDateTime'] != 'off') :?>
                                                                            ...
                                                                            <tr><td style="font-size:14px;color:#777777">
                                                                                <?php echo $ticket['WooCommerceEventsHour']; ?>:<?php echo $ticket['WooCommerceEventsMinutes']; ?>
                                                                                <?php if($ticket['WooCommerceEventsHourEnd'] != '00') : ?>
                                                                                - <?php echo $ticket['WooCommerceEventsHourEnd']; ?>:<?php echo $ticket['WooCommerceEventsMinutesEnd']; ?>
                                                                                <?php endif; ?>
                                                                            </td></tr>
                                                                        <?php endif; ?>
                                                                        ...
                                                                        <tr>
                                                                                <td>
                                                                                        <table width="150" border="0" cellspacing="0" cellpadding="9" align="left" style="background-color:<?php echo $ticket['WooCommerceEventsTicketButtonColor']; ?>;border-collapse:collapse">
                                                                                                ...
                                                                                                <tr>
                                                                                                        <td align="center">
                                                                                                                <a href="<?php echo site_url(); ?>/wp-admin/admin-ajax.php?action=woocommerce_events_ics&event=<?php echo $ticket['WooCommerceEventsProductID']; ?>" style="color:<?php echo $ticket['WooCommerceEventsTicketTextColor']; ?>;text-decoration:none;font-size:16px"><?php _e('Add to calendar', 'woocommerce-events'); ?></a>
                                                                                                        </td>
                                                                                                </tr>
                                                                                                <?php endif; ?>
                                                                                        </table>
                                                                        ...
                                                                        <tr><td><?php echo $ticket['WooCommerceEventsTicketText']; ?></td></tr>
                                                                        <?php endif; ?>
                                                                </table>
                                                        </td>
                                                </tr>
