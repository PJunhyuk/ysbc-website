...
<p><b><?php _e('Start time:', 'woocommerce-events'); ?> </b> <?php echo $WooCommerceEventsHour.':'.$WooCommerceEventsMinutes; ?></p>
<?php endif; ?>
<?php if(!empty($WooCommerceEventsHourEnd) && !empty($WooCommerceEventsMinutesEnd)) :?>
<p><b><?php _e('End time:', 'woocommerce-events'); ?> </b> <?php echo $WooCommerceEventsHourEnd.':'.$WooCommerceEventsMinutesEnd; ?></p>
<?php endif; ?>
